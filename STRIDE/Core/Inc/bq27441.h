...
/// Bit positions for the 16-bit data of CONTROL_STATUS. CONTROL_STATUS instructs the fuel gauge to return status information to
/// @return Control() addresses 0x00 and 0x01. The read-only status word contains status
